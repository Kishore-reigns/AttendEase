          ...
          children: [
              ...
              child: Stack(
                ...
                children: [
                  CircularProgressIndicator(
                    value: calculateAttendancePercentage(attendedClasses,totalClasses)/100,
                    strokeWidth: 6,
            ...
            TableCalendar(
              ...
              calendarStyle: CalendarStyle(
                ...
                weekendTextStyle: TextStyle(color: Colors.yellow), // Color for weekend dates
                defaultTextStyle: TextStyle(color: Colors.white), // Color for regular dates
                outsideDaysVisible: false,
                holidayTextStyle: TextStyle(color: Colors.orange), // Color for holiday dates
              ),
              daysOfWeekStyle: DaysOfWeekStyle(
                weekendStyle: TextStyle(color: Colors.yellow), // Color for weekend labels
                weekdayStyle: TextStyle(color: Colors.white), // Color for weekday labels
